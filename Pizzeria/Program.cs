        ...
        try
        {
            ...
            switch (pizza)
            {
                case Pizza.Carbonara:
                    ...
                    if (pizzaQuantity % 5 == 0)
                    {
                        freePizza = pizzaQuantity / 5;
                        totalCost -= 15 * freePizza;
                    }
                    totalCost += result;
            ...
            Console.WriteLine($"You take {freePizza} free pizza");
